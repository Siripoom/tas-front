...
import { Card, Row, Col, Statistic, Select, Progress, Tag } from "antd";
import {
  Users,
  Calendar,
  FileText,
...
export default function AdminHome() {
  ...
  // Get current activity data based on selected department, year, and category
  const getCurrentActivityData = () => {
    let data = activityCategories[selectedDepartment]?.[selectedAcademicYear] || [];
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-800">
                    สรุปภาพรวม {selectedDepartment} - ปีการศึกษา{" "}
